...
1. **Import Product from a Fulfillment Platform**
2. **Create Self-Fulfilled Product Manually**

This Quickstart tutorial walks you through the first method: import product from a fulfillment platform.

To explore more about customizable product, visit [Products tutorial](/chinese/products/products).
...
<Info>To explore more about mockups, visit [Products tutorial](/chinese/products/products).</Info>
