...
<Tip>**Prerequisites** : Before you begin, make sure to [install the Shopify App](/docs/connections/shopify#install-the-shopify-app) and [enable the App on your Theme](/docs/connections/shopify#enable-the-app-on-your-theme).</Tip>
